...
use crate::utils::{lsb, pop_count, remove_lsb, COLOR};
...
const PAWN_SCORES_ENDGAME: [i32; 64] = [
    ...
    10, 10, 20, 20, 20, 20, 20, 20, 20, 20, 40, 40, 40, 40, 40, 40, 40, 40, 100, 100, 100, 100,
...
const BISHOP_SCORES_ENDGAME: [i32; 64] = [
    -20, -10, -10, -10, -10, -10, -10, -20, -10, 5, 0, 0, 0, 0, 5, -10, -10, 0, 5, 10, 10, 5, 0,
    -10, -10, 5, 5, 10, 10, 5, 5, -10, -10, 0, 10, 10, 10, 10, 0, -10, -10, 10, 10, 10, 10, 10, 10,
...
const QUEEN_SCORES: [i32; 64] = [
    -20, -10, -10, -5, -5, -10, 0, -20, -10, 0, 0, 0, 0, -5, 0, -10, -10, 0, 5, 5, 5, 5, 0, 0, 0,
    0, 5, 5, 5, 5, 0, -5, -5, 0, 5, 5, 5, 5, 0, -10, -10, 0, 5, 0, 0, 0, 0, -10, -10, 0, 0, 0, 0,
    0, 0, -10, -20, -10, -10, -5, -5, -10, -10, -20,
];
...
const KING_SCORES_ENDGAME: [i32; 64] = [
    -50, -40, -30, -20, -20, -30, -40, -50, -40, -30, -20, -10, -10, -20, -30, -40, -30, -20, -10,
    20, 20, -10, -20, -30, -20, -10, 20, 30, 30, 20, -10, -20, -20, -10, 20, 30, 30, 20, -10, -20,
    -30, -20, -10, 20, 20, -10, -20, -30, -40, -30, -20, -10, -10, -20, -30, -40, -50, -40, -30,
    -20, -20, -30, -40, -50,
];

const ROOK_SCORES: [i32; 64] = [
    0, 0, 0, 5, 5, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, 5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0,
    -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 10, 10, 10, 10, 10, 10, -5, 0, 0,
    0, 0, 0, 0, 0, 0,
];
...
impl Board {
    ...
    pub fn static_evaluation_naive(&self) -> i32 {
        let mut score = 0f32;
        let opponent_occupancy = self.opponent_pieces.pawn
        ...
        let my_occupancy = self.my_pieces.pawn
    ...
    pub fn static_evaluation(&self, adjusted: bool) -> i32 {
        ...
        if adjusted {
            ((1024 - DELTA) * psqt + (1024 + DELTA) * positional) / (1024 * OUTPUT_SCALE)
        } else {
    ...
    fn ev_piece(
        ...
        while x != 0 {
            ...
            let _sq_index = if is_white { sq } else { 63 - sq };

            score += piece_val as f32;
            score += table[_sq_index as usize] as f32 * (1_f32 - end_gameness)
                + table_endgame[_sq_index as usize] as f32 * end_gameness;
